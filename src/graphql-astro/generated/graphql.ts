...
export type Mutation = {
  ...
  Newsletter_subscribe: SubscriptionResponseOutput;
  /** Darse de baja del newsletter (público) */
  Newsletter_unsubscribe: SubscriptionResponseOutput;
  ...
  usuario_updateRoles: UsuarioOutput;
...
export type MutationCurso_AddCategoriasArgs = {
  categoriaIds: Array<Scalars['ID']['input']>;
  cursoId: Scalars['ID']['input'];
};
...
export type MutationCurso_RemoveCategoriasArgs = {
  categoriaIds: Array<Scalars['ID']['input']>;
  cursoId: Scalars['ID']['input'];
};
...
export type MutationNewsletter_SubscribeArgs = {
  input: CreateSubscriberInput;
};


export type MutationNewsletter_UnsubscribeArgs = {
  email: Scalars['String']['input'];
};
...
export type MutationUsuario_UpdateRolesArgs = {
  id: Scalars['ID']['input'];
...
/** Fuente de donde provino la suscripción */
export enum NewsletterSource {
  Manual = 'MANUAL',
  RegisterForm = 'REGISTER_FORM',
  WebFooter = 'WEB_FOOTER'
}
...
export type Query = {
  ...
  /** Lista de suscriptores activos (admin) */
  Newsletter_allActive: Array<Newsletter>;
  /** Total de suscriptores activos (admin) */
  Newsletter_countActive: Scalars['Int']['output'];
  Opcion: Opcion;
...
export type SubscriptionResponseOutput = {
  __typename?: 'SubscriptionResponseOutput';
...
export type Newsletter_SubscribeMutationVariables = Exact<{
  input: CreateSubscriberInput;
}>;


export type Newsletter_SubscribeMutation = { __typename?: 'Mutation', Newsletter_subscribe: { __typename?: 'SubscriptionResponseOutput', success: boolean, message: string, email?: string | null } };

export type Newsletter_UnsubscribeMutationVariables = Exact<{
  email: Scalars['String']['input'];
}>;


export type Newsletter_UnsubscribeMutation = { __typename?: 'Mutation', Newsletter_unsubscribe: { __typename?: 'SubscriptionResponseOutput', success: boolean, message: string, email?: string | null } };

export type Newsletter_AllActiveQueryVariables = Exact<{ [key: string]: never; }>;


export type Newsletter_AllActiveQuery = { __typename?: 'Query', Newsletter_allActive: Array<{ __typename?: 'Newsletter', _id: string, email: string, name?: string | null, isActive: boolean, source: NewsletterSource, createdAt: any, updatedAt: any }> };

export type Newsletter_CountActiveQueryVariables = Exact<{ [key: string]: never; }>;
...
export const Newsletter_SubscribeDocument = gql`
    mutation Newsletter_subscribe($input: CreateSubscriberInput!) {
  Newsletter_subscribe(input: $input) {
    ...
    `;
export type Newsletter_SubscribeMutationFn = Apollo.MutationFunction<Newsletter_SubscribeMutation, Newsletter_SubscribeMutationVariables>;

/**
 * __useNewsletter_SubscribeMutation__
 *
 * To run a mutation, you first call `useNewsletter_SubscribeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useNewsletter_SubscribeMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [newsletterSubscribeMutation, { data, loading, error }] = useNewsletter_SubscribeMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useNewsletter_SubscribeMutation(baseOptions?: Apollo.MutationHookOptions<Newsletter_SubscribeMutation, Newsletter_SubscribeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<Newsletter_SubscribeMutation, Newsletter_SubscribeMutationVariables>(Newsletter_SubscribeDocument, options);
      }
export type Newsletter_SubscribeMutationHookResult = ReturnType<typeof useNewsletter_SubscribeMutation>;
export type Newsletter_SubscribeMutationResult = Apollo.MutationResult<Newsletter_SubscribeMutation>;
export type Newsletter_SubscribeMutationOptions = Apollo.BaseMutationOptions<Newsletter_SubscribeMutation, Newsletter_SubscribeMutationVariables>;
export const Newsletter_UnsubscribeDocument = gql`
    mutation Newsletter_unsubscribe($email: String!) {
  Newsletter_unsubscribe(email: $email) {
    success
    message
    email
  }
    ...
    `;
export type Newsletter_UnsubscribeMutationFn = Apollo.MutationFunction<Newsletter_UnsubscribeMutation, Newsletter_UnsubscribeMutationVariables>;

/**
 * __useNewsletter_UnsubscribeMutation__
 *
 * To run a mutation, you first call `useNewsletter_UnsubscribeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useNewsletter_UnsubscribeMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [newsletterUnsubscribeMutation, { data, loading, error }] = useNewsletter_UnsubscribeMutation({
 *   variables: {
 *      email: // value for 'email'
 *   },
 * });
 */
export function useNewsletter_UnsubscribeMutation(baseOptions?: Apollo.MutationHookOptions<Newsletter_UnsubscribeMutation, Newsletter_UnsubscribeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<Newsletter_UnsubscribeMutation, Newsletter_UnsubscribeMutationVariables>(Newsletter_UnsubscribeDocument, options);
      }
export type Newsletter_UnsubscribeMutationHookResult = ReturnType<typeof useNewsletter_UnsubscribeMutation>;
export type Newsletter_UnsubscribeMutationResult = Apollo.MutationResult<Newsletter_UnsubscribeMutation>;
export type Newsletter_UnsubscribeMutationOptions = Apollo.BaseMutationOptions<Newsletter_UnsubscribeMutation, Newsletter_UnsubscribeMutationVariables>;
export const Newsletter_AllActiveDocument = gql`
    query Newsletter_allActive {
  Newsletter_allActive {
    _id
    email
    name
    isActive
...
/**
 * __useNewsletter_AllActiveQuery__
 *
 * To run a query within a React component, call `useNewsletter_AllActiveQuery` and pass it any options that fit your needs.
 * When your component renders, `useNewsletter_AllActiveQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useNewsletter_AllActiveQuery({
 *   variables: {
 *   },
 * });
 */
export function useNewsletter_AllActiveQuery(baseOptions?: Apollo.QueryHookOptions<Newsletter_AllActiveQuery, Newsletter_AllActiveQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Newsletter_AllActiveQuery, Newsletter_AllActiveQueryVariables>(Newsletter_AllActiveDocument, options);
      }
export function useNewsletter_AllActiveLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Newsletter_AllActiveQuery, Newsletter_AllActiveQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Newsletter_AllActiveQuery, Newsletter_AllActiveQueryVariables>(Newsletter_AllActiveDocument, options);
        }
export function useNewsletter_AllActiveSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Newsletter_AllActiveQuery, Newsletter_AllActiveQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Newsletter_AllActiveQuery, Newsletter_AllActiveQueryVariables>(Newsletter_AllActiveDocument, options);
        }
export type Newsletter_AllActiveQueryHookResult = ReturnType<typeof useNewsletter_AllActiveQuery>;
export type Newsletter_AllActiveLazyQueryHookResult = ReturnType<typeof useNewsletter_AllActiveLazyQuery>;
export type Newsletter_AllActiveSuspenseQueryHookResult = ReturnType<typeof useNewsletter_AllActiveSuspenseQuery>;
export type Newsletter_AllActiveQueryResult = Apollo.QueryResult<Newsletter_AllActiveQuery, Newsletter_AllActiveQueryVariables>;
export const Newsletter_CountActiveDocument = gql`
    query Newsletter_countActive {
  Newsletter_countActive
}
    `;

/**
 * __useNewsletter_CountActiveQuery__
 *
 * To run a query within a React component, call `useNewsletter_CountActiveQuery` and pass it any options that fit your needs.
 * When your component renders, `useNewsletter_CountActiveQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useNewsletter_CountActiveQuery({
 *   variables: {
 *   },
 * });
 */
export function useNewsletter_CountActiveQuery(baseOptions?: Apollo.QueryHookOptions<Newsletter_CountActiveQuery, Newsletter_CountActiveQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Newsletter_CountActiveQuery, Newsletter_CountActiveQueryVariables>(Newsletter_CountActiveDocument, options);
      }
export function useNewsletter_CountActiveLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Newsletter_CountActiveQuery, Newsletter_CountActiveQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Newsletter_CountActiveQuery, Newsletter_CountActiveQueryVariables>(Newsletter_CountActiveDocument, options);
        }
export function useNewsletter_CountActiveSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Newsletter_CountActiveQuery, Newsletter_CountActiveQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Newsletter_CountActiveQuery, Newsletter_CountActiveQueryVariables>(Newsletter_CountActiveDocument, options);
        }
export type Newsletter_CountActiveQueryHookResult = ReturnType<typeof useNewsletter_CountActiveQuery>;
